...
class AccountBalanceTestCase(unittest.TestCase):
    ...
    def test_deposit(self):
        ...
        self.assertEqual(self.account_yangu.balance, 7000, msg='Deposit Method Inacurate')

    def test_withdraw(self):
        self.account_yangu.withdraw(500)
        self.assertEqual(self.account_yangu.balance, 2500, msg='Withdraw method innacurate')
